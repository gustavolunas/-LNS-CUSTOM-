...
buttonImbuiment.ImbuirCavebot.onClick = function()
  if CaveBot and CaveBot.addAction then
      CaveBot.addAction("function", "checkerImbuementsList()\nreturn true", true)

      CaveBot.addAction("delay", "8000", false)
...
-- ==========================================================
local imbuimentInterface = setupUI([[
...
-- ==========================================================
-- TIMER WINDOW (na tela) - lista de tempos via LOOK
-- ==========================================================
-- ==========================================================
-- TIMER WINDOW (na tela) - lista de tempos via LOOK
-- + SALVA POSIÇÃO
-- + ARRASTAR (PC: CTRL / MOBILE: F2)
-- ==========================================================
